...
class NuevoCliente(Dialogo):
    ...
    def registrar(self):
        ...
        if querys.registrar_cliente(datos):
            evt.salir(self)
...
class EditarCliente(Dialogo):
    ...
    def cargarPersonas(self):
        self.__personas = querys.todas_las_personas(self.buscar.get())
    ...
    def aplicar(self):
        if self.__persona_actual:
            ...
            if querys.actualizar_cliente(self.__persona_actual):
                evt.salir(self)
        else:
...
class BorrarCliente(Dialogo):
    ...
    def aplicar(self):
        if self.__persona_actual:
            ...
            self.__persona_actual['cliente'] = self.var_cliente.get()
            self.__persona_actual['activo'] = self.var_activo.get()
            if querys.borrar_cliente(self.__persona_actual):
                evt.salir(self)
        else:
            mb.showerror(title="Error", message="No hay resultados.")
...
class NuevoProducto(Dialogo):
    ...
    def cargarCategorias(self):
        self.__categorias['values'] = querys.todas_las_categorias()
    ...
    def registrar(self):
        ...
        id = querys.id_categoria(self.__categorias.get())
        if id:
            datos['id_categoria'] = id
            if querys.registrar_producto(datos):
                evt.salir(self)
...
class EditarProducto(Dialogo):
    ...
    def cargarProductos(self):
        self.__categorias['values'] = querys.todas_las_categorias()
        self.__productos = querys.todos_los_productos()
    ...
    def ponerValores(self, pos):
        try:
            ...
            self.__stock.delete(0, 'end')
            # cargo los datos
            self.__categorias.set(querys.nombre_categoria(self.__producto_actual['id_categoria']))
    ...
    def aplicar(self):
        if self.__producto_actual:
            self.__producto_actual['id_categoria'] = querys.id_categoria(self.__categorias.get())
            ...
            if querys.actualizar_producto(self.__producto_actual):
                evt.salir(self)
                evt.cargarProductos(self.__tabla, '')
        else:
            mb.showerror(title="Error", message="No hay resultados.")
...
class BorrarProducto(Dialogo):
    ...
    def ponerValores(self, pos):
        try:
            ...
            self.__stock.delete(0, 'end')
            # cargo los datos
            self.__categoria.insert(0, querys.nombre_categoria(self.__producto_actual['id_categoria']))
            self.__descr.insert(0, self.__producto_actual['descripcion'])
            self.__precio.insert(0, self.__producto_actual['precio'])
            self.__stock.insert(0, self.__producto_actual['stock'])
            self.__var_activo.set(value=bool(self.__producto_actual['activo']))
    ...
    def aplicar(self):
        if self.__producto_actual:
            if querys.borrar_producto(self.__producto_actual):
                evt.salir(self)
                evt.cargarProductos(self.__tabla, '')
        else:
            mb.showerror(title="Error", message="No hay resultados.")
...
class NuevaCategoria(Dialogo):
    ...
    def registrar(self):
        if querys.registrar_categoria(self.__nombre.get()):
            evt.salir(self)
...
class EditarCategoria(Dialogo):
    ...
    def cargarCategorias(self):
        self.__categorias = querys.todas_las_categorias()
    ...
    def aplicar(self):
        if querys.actualizar_categoria(self.__categoria_actual, self.__nombre.get()):
            evt.salir(self)
...
class Compras(Dialogo):
    ...
    def cargarCompras(self):
        resultados = querys.compras_cliente(self.__cliente)
...
class Ventas(Dialogo):
    ...
    def cargarVentas(self):
        resultados = querys.todas_las_ventas_de()
